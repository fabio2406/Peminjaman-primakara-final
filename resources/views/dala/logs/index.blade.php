...
<div class="container">
    ...
    <div class="mb-3 d-flex justify-items-between">
        <input type="date" class="form-control flex-fill me-2" id="from_date" name="from_date">
        <input type="date" class="form-control flex-fill ms-2" id="until_date" name="until_date">
    </div>
...
$(document).ready(function() {
    ...
    function filterLogs(url = "{{ route('dala.logs.index') }}") {
